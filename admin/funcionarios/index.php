      ...
      <main class="ms-auto col-lg-10 px-md-4">
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="row mb-3">
            ...
            </div> <table class="table" style="background-color: #2b3d4f; color: white;">
              <thead> 
                <tr style="background-color: #2b3d4f; color: white;">
                  ...
                  <th class="text-white" style="background-color: #2b3d4f;">Observação</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="table-light"><?php echo $funcionario['foto'] ?>
                  <?php 
                    if ($funcionario['foto'] != '') {
                      echo '<img src="../../images/' . $funcionario['foto'] . '" alt="Foto do Funcionário" "class="rounded-pill" style="width: 50px; height: 50px;">';
                    } else {
                      echo '<img src="../../assets/img/placeholder-funcionario.png" alt="Foto padrão" "class="rounded-pill" style="width: 50px; height: 50px;">'; // Ou uma imagem padrão caso não haja foto
                    }
