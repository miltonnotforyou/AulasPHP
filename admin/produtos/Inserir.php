                    ...
                    <div class="row ">
                       ...
                       <div class="col-md-9">
                        <div class="row">
                            ...
                            <div class="col-md-3 mt-2">
                                <label for="preco_venda"><strong class="text-danger">*</strong> Preço Venda</label>
                            ...
                            <div class="col-md-2 mt-2">
                                ...
                                <input type="number" name="preco_promocao" id="preco_promocao" class="form-control" step="0.01" min="0" readonly>
                            </div>
                            <div class="col-md-3 mt-2">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea name="descricao" id="descricao" class="form-control" maxlength="100" rows="3"></textarea>

                                <input type="hidden" name="cadastrar" value="cadastrar_produto"> 
                                <button type="submit" class="btn btn-dark mt-3 px-4">Cadastrar Produto</button>
                            </div>
