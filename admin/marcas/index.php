          ...
          <table class="table table-striped table-hover">
              <thead>
                  <tr style="background-color: #2b3d4f; color: white;"> 
                      ...
                      <th class="text-white" style="background-color: #2b3d4f; color: white;">Marca</th>
              ...
              <tbody>
                ...
                ?>
                <tr>
                  <td class="table-light"><?php echo $marca['codigo_marca'] ?></td>
                  <td class="table-light"><?php echo $marca['nome'] ?></td>
                  <td class="table-light"><?php echo $marca['observacao'] ?></td>
